...
\usepackage[a4paper,lmargin=25mm, textwidth=160mm, tmargin=20mm, textheight=257mm]{geometry}
...
%***************************************************
%Theorem settings
\newtheorem{theorem}{Teorema} % define theorem environment, the "theorem" blocks will be numbered with "Teorema 1", "Teorema 2", etc.
