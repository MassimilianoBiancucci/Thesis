...
Per la definizione della pipeline di generazione dei dati, si è partiti dal concetto di \textit{generative adversarial network} (GAN), che è una tecnica di \textit{machine learning}
...
in modo lineare, senza retropropagazioni intermedie dell'informazione.
    ...
    \begin{figure}[H]
        \centering
        \includesvg[width=0.5\textwidth]{imgs/es_nn_2.svg}
...
%reduce the font size of the itemize
\begin{itemize}
...
Di seguito è riportata l'immagine \ref{fig:lena} di Lena Forsén, un'attrice svedese la cui foto è usata frequentemente per esempi e test di algoritmi di 
...
\begin{comment}
    Link utili per la sezione:
        - https://towardsdatascience.com/intuitively-understanding-convolutions-for-deep-learning-1f6f42faee1
        - https://towardsdatascience.com/a-comprehensive-introduction-to-different-types-of-convolutions-in-deep-learning-669281e58215
    Come continuare la sezione?
    - continuare con i possibili parametri della convoluzione:
        - padding
        - stride
        - kernel size
        - numero di filtri
    - La convoluzione multicanale
    - pooling
...
\subsection{La convoluzione multichannel}
...
Facciamo però un pò di chiarezza sulla differenza tra kernel e filtro, nella convoluzione 2D, con kernel si intende la matrice di pesi 
...
$m \times n \times W_k \times H_k$, dove $W_k$ e $H_k$ sono le dimensioni del kernel.
    % image of multichannel_convolution
    \begin{figure}[h]
        \centering
